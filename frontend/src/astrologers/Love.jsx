...
export default function Love() {
  ...
  useEffect(() => {
    const fetchLoveAdvisors = async () => {
      try {
        const res = await axios.get(
          `${import.meta.env.VITE_BASE_URL}/api/psychics/type/love`
        );
        console.log("Fetched love psychics:", res.data.data);
        ...
        console.error("Error fetching love advisors:", err);
        setPsychics([]);
      } finally {
        setLoading(false);
      }
                ...
                <TabsContent value="active">
                  <div className="grid gap-6">
                    {loading ? (
                      ...
                      <p className="text-center mt-6">No love advisors available.</p>
                    ) : (
